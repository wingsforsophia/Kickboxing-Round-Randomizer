...
const round2 = {
    ...
    'combos':  ['Jab, Left-Body-Hook, Right-Body-Hook, Left-Uppercut, Cross',
                ...
                'C, Left-Hook, Left-Uppercut, RH',
                'Jab, Left-Hook, RH, Right-Head-Hook',
                'C, Left-Hook, Right-Uppercut, Left-Hook',
                'Jab, C, Left-Hook, Right-Uppercut ',
                'Left-Body-Hook, Right-Uppercut, body jab, C',
                'C, Left-Body-Hook, Right-Head-Hook',
                ' C, Jab, Jab, RH ',
                'Right-Uppercut, Jab, C, Left-Body-Hook',
                'RH, Left-Hook, RH, Left-Uppercut',
                'Right-Uppercut, Left-Uppercut, C, Left-Uppercut',
                'Jab, Jab, C, Left-Hook ',
                'Right-Uppercut, Left-Hook, RH, Left-Uppercut',
                'C, Left-Uppercut, Left-Uppercut, RH',
                ' C, Left-Body-Hook, Left-HookH, C',
                'C, Left-Hook, RH',
                'C, Left-Body-Hook, Right-Uppercut, Right-Body-Hook ',
